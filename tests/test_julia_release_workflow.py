...
def test_julia_release_workflow_and_checklist_align() -> None:
    ...
    assert "The Julia binding remains the thin adapter over the shared contract." in checklist_text
    assert "Julia General registry submission/approval remains external/manual." in checklist_text
