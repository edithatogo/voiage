...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("conditional_value_assurance",), [], "must be an object"),
        (
        ...
        (("conditional_values",), "bad", "list of model rows"),
        (("conditional_values", 0), "bad", "row must align"),
