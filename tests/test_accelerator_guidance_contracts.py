...
def test_accelerator_guidance_mentions_fpga_and_asic_lanes() -> None:
    ...
    performance_text = (root / "docs" / "user_guide" / "performance_guide.md").read_text()
    roadmap_text = (root / "docs" / "developer_guide" / "hpc_native_roadmap.rst").read_text()
    contract_text = (root / "docs" / "developer_guide" / "hpc_acceleration_abstraction_contract.rst").read_text()
