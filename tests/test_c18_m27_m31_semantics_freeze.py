...
FREEZE = ROOT / "conductor/tracks/supported_frontier_method_completion_20260723/c18-m27-m31-semantics-freeze.json"
...
def test_m27_m31_semantics_freeze_matches_artifacts() -> None:
    ...
    assert [family["issue"] for family in payload["families"]] == [596, 597, 598, 599, 600]
