...
def test_nma_evpi_basic(sample_nma_data):
...
def test_nma_evpi_with_population(sample_nma_data):
...
def test_nma_evpi_with_wtp(sample_nma_data):
    """Test NMA-EVPI with willingness-to-pay threshold."""
    result_no_wtp = calculate_nma_evpi(sample_nma_data, n_samples=500)
...
def test_nma_evppi_basic(sample_nma_data):
...
def test_nma_evpi_dict_missing_key():
