...
def test_go_release_workflow_and_checklist_align() -> None:
    ...
    assert "The Go binding remains the thin adapter over the shared contract." in checklist_text
    assert "Module publication is driven by semver tag pushes and downstream module proxy indexing." in checklist_text
