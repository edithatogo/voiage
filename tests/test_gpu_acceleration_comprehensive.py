...
class TestGetGPUBackend:
    ...
    def test_get_gpu_backend_with_jax(self, monkeypatch) -> None:
    ...
    def test_get_gpu_backend_with_cupy(self, monkeypatch) -> None:
    ...
    def test_get_gpu_backend_with_torch(self, monkeypatch) -> None:
    ...
    def test_get_gpu_backend_none_available(self, monkeypatch) -> None:
...
class TestIsGPUAvailable:
    ...
    def test_is_gpu_available_with_backends(self, monkeypatch) -> None:
...
class TestArrayTransferFunctions:
    ...
    def test_array_to_gpu_with_backend_specified(self, monkeypatch) -> None:
    ...
    def test_array_to_gpu_unknown_backend(self) -> None:
    ...
    def test_array_to_cpu_default_behavior(self) -> None:
    ...
    def test_array_to_cpu_unknown_backend(self) -> None:
...
class TestGPUAcceleratedEVPI:
    ...
    def test_gpu_accelerated_evpi_initialization(self, monkeypatch) -> None:
    ...
    def test_gpu_accelerated_evpi_initialization_with_invalid_backend(self) -> None:
        """Test GPUAcceleratedEVPI initialization with invalid backend."""
        with pytest.raises(ValueError, match="Unknown backend"):
            GPUAcceleratedEVPI(backend="invalid_backend")

    def test_gpu_accelerated_evpi_calculate_evpi(self, monkeypatch) -> None:
...
class TestGPUModuleEdgeCases:
    ...
    def test_get_gpu_backend_jax_no_devices(self, monkeypatch) -> None:
    ...
    def test_get_gpu_backend_jax_device_kind_not_gpu(self, monkeypatch) -> None:
    ...
    def test_get_gpu_backend_cupy_runtime_error(self, monkeypatch) -> None:
    ...
    def test_array_to_cpu_with_detected_backends(self, monkeypatch) -> None:
    ...
    def test_gpu_accelerated_evpi_with_different_backends(self, monkeypatch) -> None:
