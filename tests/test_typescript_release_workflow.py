...
def test_typescript_release_workflow_and_checklist_align() -> None:
    ...
    assert "The TypeScript binding remains the thin adapter over the shared contract." in checklist_text
    assert "npm publication is automated on `typescript-v*` tags with provenance." in checklist_text
