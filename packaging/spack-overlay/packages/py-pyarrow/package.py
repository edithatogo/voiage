...
class PyPyarrow(PythonPackage):
    ...
    depends_on("cmake@3.25:", when="@25:", type="build")
    depends_on("py-scikit-build-core", when="@25:", type="build")
    depends_on("py-cython@3.1:", when="@25:", type="build")
    depends_on("py-libcst@1.8.6:", when="@25:", type="build")
    depends_on("py-numpy@1.25:", when="@25:", type=("build", "run"))
