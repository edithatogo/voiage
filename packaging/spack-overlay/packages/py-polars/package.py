...
from spack.package import depends_on, license, maintainers, variant, version, when
...
class PyPolars(PythonPackage):
    ...
    version("1.42.1", sha256="2fe94f3059334650bd850ae19a9c165dcd5d9cb12cd95ea04de2201662e70e8a")
    ...
    depends_on("python@3.10:", when="@1.42.1:", type=("build", "run"))
    depends_on("py-setuptools@61:", when="@1.42.1:", type="build")
    depends_on("py-wheel", when="@1.42.1:", type="build")
    depends_on("py-polars-runtime-32@1.42.1", when="@1.42.1", type="run")
