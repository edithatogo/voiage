...
from spack.package import depends_on, license, version, when
...
class PyTyper(PythonPackage):
    ...
    depends_on("python@3.10:", when="@0.27.2:", type=("build", "run"))
    depends_on("py-rich@13.8:", when="@0.27.2:", type=("build", "run"))
    depends_on("py-annotated-doc@0.0.2:", when="@0.27.2:", type=("build", "run"))
