# Arrow 25.0.1 provider candidate for foss 2023a

This isolated overlay adds Arrow and PyArrow 25.0.1 to the Python 3.12.14
foundation. Its six easyconfigs resolve a 79-module dependency graph with
...
GCC 12.3.0 and CMake 3.26.3 meet those requirements. Explicit dependencies
...
The identical source evidence retained from the 2024a provider candidate records how a separate macOS Python 3.12.13 environment source-built the backend
...
The older foundation manifests and historical build records are unchanged. The source evidence predates this generation port and does not claim that the 2023a recipes were compiled.
...
```sh
eb packaging/easybuild-2023a-arrow-overlay/2023a/Arrow-25.0.1-gfbf-2023a.eb \
  --robot --dry-run \
  --robot-paths=packaging/easybuild-2023a-arrow-overlay/2023a:packaging/easybuild-2023a-rust-overlay/2023a:packaging/easybuild-2023a-overlay/2023a:"$EASYBUILD_CATALOGUE" \
