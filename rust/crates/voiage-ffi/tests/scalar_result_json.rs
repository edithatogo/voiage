...
#[test]
fn invalid_scalar_result_does_not_write_required_size() {
    let invalid = br#"{"analysis_type":"evsi","sample_size":0}"#;
...
#[test]
fn scalar_result_json_capability_bit_is_nonzero() {
    assert_ne!(VOIAGE_ABI_SCALAR_RESULT_JSON, 0);
}
