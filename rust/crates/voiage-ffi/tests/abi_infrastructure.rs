...
use voiage_ffi::{
    ...
    VOIAGE_ABI_ENBS, VOIAGE_ABI_EVPI_RESULT, VOIAGE_ABI_EVPPI_REGRESSION_RESULT,
    VOIAGE_ABI_EVSI_APPROXIMATION_RESULT, VOIAGE_ABI_EXPECTED_LOSS_RESULT,
...
fn capability_query_advertises_typed_evpi_results() {
    ...
    assert_eq!(capabilities.capability_bits & !0b1_1111_1111_1111, 0);
}
