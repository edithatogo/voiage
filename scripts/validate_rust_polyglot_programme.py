...
FRONTIER_METHOD_GAP_SUBISSUES: dict[int, dict[str, str]] = {
    ...
    593: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "implementation-information-decomposition",
        "moscow": "Must",
        "priority": "P0",
        "risk level": "High",
        "gate": "Local",
    ...
    594: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "uncertainty-modelling-value",
        "moscow": "Must",
        "priority": "P0",
        "risk level": "High",
        "gate": "Local",
    ...
    595: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "risk-adjusted-information-pricing",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "High",
        "gate": "Local",
    ...
    596: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "event-localized-information-value",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "Medium",
        "gate": "Local",
    ...
    597: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "belief-state-sequential-information-value",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "High",
        "gate": "Local",
    ...
    598: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "signed-social-information-value",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "High",
        "gate": "Local",
    ...
    599: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "heterogeneity-value-decomposition",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "High",
        "gate": "Local",
    ...
    600: {
        "track id": FRONTIER_TRACK,
        "parent issue": str(FRONTIER_PARENT_ISSUE),
        "record id": "outcome-conditional-sample-information-value",
        "moscow": "Should",
        "priority": "P1",
        "risk level": "Medium",
        "gate": "Local",
