...
- [ ] **P1-T4 / AC-01:** Verify that the core contract imports no external
  ingestion dependency.
- [ ] **P1-T5 / AC-01:** Run automated review, focused tests, schema validation,
...
- [ ] **P2-T3 / AC-02:** Propagate artifact IDs and normalized input digests
  through `AnalysisSpec`, `RunContext`, diagnostics, and provenance.
- [ ] **P2-T4 / AC-02:** Add the method/input capability matrix and preserve
  existing direct Python and CSV entry points.
- [ ] **P2-T5 / AC-02:** Run direct-versus-normalized numerical-equivalence
...
- [ ] **P3-T4 / AC-03:** Document the third-party provider extension contract.
- [ ] **P3-T5 / AC-03:** Verify clean base installation, run automated review,
...
- [ ] **P4-T2 / AC-04:** Write failing offline fixtures/tests for versioning,
  ...
  ambiguous semantics.
- [ ] **P4-T3 / AC-04:** Implement the lazy optional Croissant provider and
  documented supported profile.
- [ ] **P4-T4 / AC-04:** Add Croissant inspection, diagnostics, provenance, and
  one opt-in authoritative live interoperability probe.

### Frictionless Data

- [ ] **P4-T5 / AC-05:** Review and record the Frictionless dependency and
  supported-profile decision through the same dependency-frontier evidence.
- [ ] **P4-T6 / AC-05:** Write failing offline fixtures/tests for package and
  data validation, resources, schemas, dialects, types, constraints, missing
  values, keys, integrity, supported tabular formats, and ambiguous resources.
- [ ] **P4-T7 / AC-05:** Implement the lazy optional Frictionless provider and
  documented supported profile.
- [ ] **P4-T8 / AC-05:** Add Frictionless inspection, diagnostics, provenance,
  and one opt-in authoritative live interoperability probe.

### Phase checkpoint

- [ ] **P4-T9 / AC-03–AC-05:** Verify base-import isolation and clean installs
...
- [ ] **P5-T3 / AC-06:** Implement deterministic fixture generation and the
  ...
  conformance matrix.
- [ ] **P5-T4 / AC-06:** Add malformed/adversarial cases, property-based mapping
  tests, and fresh-process PyArrow/Polars checks.
- [ ] **P5-T5 / AC-06:** Add the conformance matrix to tox and hosted CI; run
...
- [ ] **P6-T4 / AC-07:** Add Python, Croissant/ML, and
  Frictionless/operations-research examples.
- [ ] **P6-T5 / AC-07:** Update Astro data-structure, CLI, architecture, and
  security guidance plus README, changelog, roadmap, and todo.
- [ ] **P6-T6 / AC-07:** Run automated review, CLI/docs/Vale validation, clean
...
- [ ] **P7-T1 / AC-08:** Write failing traversal, archive-bomb, SSRF,
  ...
  tests.
- [ ] **P7-T2 / AC-08:** Complete source-policy enforcement and streaming or
  bounded-batch behavior.
- [ ] **P7-T3 / AC-08:** Benchmark parsing, normalization, Arrow conversion,
  memory use, and calculation separately; define representative
  non-regression thresholds.
- [ ] **P7-T4 / AC-08:** Verify Python 3.12–3.14, minimum/maximum dependencies,
  CPU fallback, numerical equivalence, Arrow round trips, base/extra wheels,
  license inventory, and SBOM changes.
- [ ] **P7-T5 / AC-08:** Run typing, Ruff, coverage, mutation targets,
  dependency audits, repository harness, full `tox`, and all hosted checks.
- [ ] **P7-T6 / AC-08:** Publish supported-standard compatibility and
  deprecation policy without claiming unsupported upstream coverage.
- [ ] **P7-T7 / AC-08:** Run automated review, resolve high-confidence
