...
- **M32-H6:** Provide enumerable catastrophe, correlation, heterogeneous-party,
  ...
  assurance.
- **M32-H7:** Keep runtime capability unsupported until candidate-bound
...
- Provide domain adapters only after domain-qualified review of the relevant
...
- Add sequential safe-design policies with stopping and harm-budget updates
  after a separate adaptive-design review.

## Won't

- Infer harm from study cost, monetize incomparable harms automatically, treat
  VoC as acquisition harm, or claim a positive ENBS authorizes a study.
