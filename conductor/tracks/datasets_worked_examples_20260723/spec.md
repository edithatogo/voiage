# Datasets and Executable Worked Examples

## Overview

Provide executable, rights-governed evidence for real decisions beyond health economics using reusable templates rather than one-off numerical engines.

Owning issue: [#321](https://github.com/edithatogo/voiage/issues/321). Parent programme issue [#313](https://github.com/edithatogo/voiage/issues/313).
Project: [VOP–VOIAGE Conductor Roadmap](https://github.com/users/edithatogo/projects/28).

## Requirements

1. Deliver the decision-grade churn/retention case under #574 and cross-industry packs under #575.
2. Deliver versioned domain-template and adapter capabilities under #577 without duplicating core estimators.
3. Require offline deterministic execution, declared assumptions, estimator uncertainty, sensitivity/failure cases and accessible outputs.
4. Preserve source rights, hashes, provenance, privacy boundaries and practitioner-review states.

## Owned issue records

[#574](https://github.com/edithatogo/voiage/issues/574), [#575](https://github.com/edithatogo/voiage/issues/575), [#577](https://github.com/edithatogo/voiage/issues/577)
...
- **AC-06:** File presence, notebook screenshots and plausible stories are insufficient; examples require clean execution, rights evidence, decision completeness and review status.
...
- GitHub issue [#321](https://github.com/edithatogo/voiage/issues/321) and its
