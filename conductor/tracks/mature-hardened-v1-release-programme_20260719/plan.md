...
- [~] Task: Enforce supported-extension boundaries using TDD
    ...
    - [x] Refactor: remove duplicated policy and unnecessary dependencies. Migrated the heterogeneity kernel and Python bridge in `8795d21`; focused Rust/Python parity and extension-boundary tests pass. Remaining Python-owned orchestration and frontier migrations stay explicitly tracked.
