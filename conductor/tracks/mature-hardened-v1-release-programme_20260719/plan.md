...
- [~] Task: Convert retained bindings into thin Rust adapters using TDD
    ...
    - [~] Green: use the C ABI for R, Julia, Go and .NET and WASM or N-API for TypeScript as justified (C ABI EVPI foundation f7cc0b7; Go adapter 2a05984; .NET adapter 26a10d7; Julia adapter 3f22b1a; R/TypeScript pending).
