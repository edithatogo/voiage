...
- [~] Task: Establish Astro as the sole documentation system using TDD
    ...
    - [~] Green: migrate unique content into Astro and remove Sphinx builds, dependencies and configuration. (active public links migrated; the quality/security guide is now authoritative at `docs/astro-site/src/content/docs/developer-guide/quality-and-security.mdx`; remaining legacy RST source migration remains)
