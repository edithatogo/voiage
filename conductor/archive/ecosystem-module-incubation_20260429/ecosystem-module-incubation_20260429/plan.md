...
- [x] Task: Document the current HEOR ecosystem roles.
    - [x] Define `voiage` as the HEOR VOI engine.
    - [x] Define `lifecourse` as the health-economic simulation producer.
    - [x] Define `innovate` as the health-intervention diffusion/adoption scenario producer.
...
- [x] Task: Document non-goals.
    - [x] Exclude generic non-HEOR modelling concerns.
...
- [x] Task: Define `voiage` HEOR ecosystem artifacts.
...
- [x] Task: Define compatibility fixtures.
    ...
    - [x] Add fixture expectations for `innovate` health-intervention adoption uncertainty to VOI workflows.
...
- [x] Task: Update docs and specs.
    - [x] Add HEOR ecosystem module strategy documentation.
