# Track Plan: Sustainability, Badging & Identifier Governance

## Phases

- **Migrated:** **Phase 1: OpenSSF Best Practices Questionnaire Mapping**
  - **Migrated:** Author `specs/submission-readiness/openssf-best-practices-evidence.md`.
  - **Migrated:** Add OpenSSF badge link to `README.md`.
- **Migrated:** **Phase 2: Fiscal Host & Identifier Governance**
  - **Migrated:** Update `SUPPORT.md` and `GOVERNANCE.md` with OSC sponsorship and steering committee roadmap.
  - **Migrated:** Synchronize `CITATION.cff` and `codemeta.json`.
