# Track Implementation Plan: Threshold, Tipping-Point, And Robust VOI Implementation

## Phase 1: Core Contract And Runtime Shape [checkpoint: ]

- [x] Task: Define the runtime threshold-VOI module surface and result types.
    - [x] Choose the canonical method name and alias surface.
    - [x] Define the result envelope and reporting fields.
    - [x] Preserve compatibility with the threshold contract scaffold.
...
## Phase 2: Deterministic Threshold Algorithm [checkpoint: ]

- [x] Task: Implement the threshold-profile decision kernel.
    - [x] Compute profile-specific optima and expected net benefit.
    - [x] Compute threshold-crossing summaries.
    - [x] Compute tipping-point or reversal matrices.
    - [x] Compute robust / ambiguity-aware decision summaries.
...
- [x] Task: Add focused unit tests for the live threshold algorithm.
...
- [x] Task: Conductor - Automated Review and Checkpoint 'Deterministic Threshold Algorithm' (Protocol in workflow.md)

## Phase 3: Fixtures, CLI, And Documentation [checkpoint: ]

- [x] Task: Add deterministic fixtures and fixture-backed conformance tests.
    - [x] Create a threshold fixture manifest and normative payload set.
...
- Keep the threshold track parallelizable: contract shape, algorithm, and
