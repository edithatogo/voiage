...
- [x] **H2:** Publish the zero-harm reduction, separability/commensurability
  ...
  (AC-02–AC-06) `97bd208`
- [x] **H3:** Run an automated estimand/domain, assurance and governance panel,
  resolve Critical/High findings, and complete the phase checkpoint. (AC-06,
  AC-08, AC-09) `eeb50c3`
- [x] **H3-R1:** Remediate the automated advisory panel's High and Medium
...
- **Migrated:** **H8-D:** Pre-screen and commission independent estimand/domain,
...
- [x] **H8-D-B:** Repair the repository-owned governance/API drift exposed by
  ...
  AC-08–AC-10) Completed by PR #865 exact head `973a79dc`, with 38 successful
...
- [x] **H8-D-D:** Under native child #870, materialize a deterministic human
  ...
  threads before squash merge `8c710245`. Issue #870 and Project 28 then read
  back Closed, Done, Resolved, Verified and Clean while retaining Gate Human
  and Risk Critical. This completes H8-D-D preparation only. (AC-06,
  AC-08–AC-12)
...
- [x] **H8-D-E-CLOSEOUT:** Validate PR #877 exact head `8de3a40a` with 38
  ...
  (AC-01, AC-07–AC-13)
- **Migrated:** **H8-D-F:** Under native child #876, obtain independently evidenced
...
- [x] **H8-D-F-A:** Owner-approved `agent_only` assurance route for this
  ...
  AC-08–AC-13)
- **Migrated:** **H8-E:** Have a separate orchestrating agent normalize the reports,
...
- **Migrated:** **H8-F:** Disposition every finding; independently verify Critical/High
  ...
  (AC-08, AC-09)
- **Migrated:** **H8-G:** Obtain candidate-bound confirmation from two distinct named
...
- **Migrated:** **H8-H:** Synchronize #853/#850, Project 28, roadmap, todo, canonical
  ...
  (AC-01, AC-08, AC-09)
- **Migrated:** **H9:** If approved, refine this track with the exact estimator, Rust
...
- **Migrated:** **H10:** Keep hosted checks, parity, stable promotion, release,
