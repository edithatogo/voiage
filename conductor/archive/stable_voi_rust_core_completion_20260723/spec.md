# Stable Rust VOI Core Completion

## Overview

Make Rust the explicit numerical authority for every accepted stable VOI method while preserving versioned v1 semantics.

Owning issue: [#316](https://github.com/edithatogo/voiage/issues/316). Parent programme issue [#313](https://github.com/edithatogo/voiage/issues/313).
Project: [VOP–VOIAGE Conductor Roadmap](https://github.com/users/edithatogo/projects/28).

## Requirements

1. Cover generalized/net benefit, expected loss, EVPI/population EVPI, EVPPI, EVSI, ENBS, optimal designs, CEAC/CEAF, dominance, extended dominance, ICER and cost-effectiveness summaries.
2. Define supported estimators, RNG, convergence, intervals, tolerances, ties, scaling, diagnostics and fail-closed unsupported behavior.
3. Publish a supported Rust facade and additive result fields without silent Python numerical divergence.
4. Require analytical, property, differential, mutation, benchmark and cross-language fixture evidence.
...
- **AC-06:** Every stable method executes through Rust or exposes an explicit compatibility disposition, versioned contract and evidence-backed failure boundary.
...
- GitHub issue [#316](https://github.com/edithatogo/voiage/issues/316) and its
