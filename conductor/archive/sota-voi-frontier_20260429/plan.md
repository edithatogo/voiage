...
- [x] Task: Define preference heterogeneity and value of individualized care contracts.
    - [x] Model preference weights separately from clinical or cost uncertainty.
    - [x] Support individual, subgroup, and population-level summaries.
...
## Phase 6: Documentation, Roadmap, And Release Readiness [checkpoint: b232d31]

- [x] Task: Update README, migration guide, roadmap, and user-guide docs.
- [x] Task: Add CHEERS-VOI reporting metadata and structured result fields.
    ...
    - [x] Expand the reporting payloads to the remaining frontier families and make them fixture-backed.
...
- [x] Task: Conductor - Automated Review and Checkpoint 'Documentation, Roadmap, And Release Readiness' (Protocol in workflow.md)

## Phase 7: Dynamic Real-Options VOI [checkpoint: b232d31]
...
- [x] Task: Add schemas and examples for dynamic real-options VOI inputs and outputs.
- [x] Task: Add deterministic fixtures and reviewable example payloads once the contract stabilizes.
- [x] Task: Conductor - Automated Review and Checkpoint 'Dynamic Real-Options VOI' (Protocol in workflow.md)

## Phase 8: Adjacent Frontier Extensions [checkpoint: b232d31]

- [x] Task: Define causal-identification, transportability, and external-validity VOI contracts.
    - [x] Model source-to-target population shifts, transport weights, and validity penalties.
    - [x] Distinguish internal validity, external validity, and transportability assumptions.
    - [x] Add the causal-transportability contract scaffold under `specs/frontier/causal-transportability/v1/`.
- [x] Task: Define data-quality, measurement-error, data-acquisition, privacy, and linkage VOI contracts.
    - [x] Model operational acquisition costs and privacy-constrained information value.
    - [x] Distinguish source quality, linkage quality, and missingness/measurement-error value.
    - [x] Add the data-quality contract scaffold under `specs/frontier/data-quality/v1/`.
- [x] Task: Define computational VOI, model-refinement VOI, expert-elicitation VOI, and evidence-synthesis design VOI contracts.
    - [x] Model compute budget, approximation error, and refinement value explicitly.
    - [x] Distinguish elicitation design value from downstream decision value.
    - [x] Add the computational contract scaffold under `specs/frontier/computational/v1/`.
- [x] Task: Add schemas, examples, fixtures, and maturity metadata for each adjacent extension family as it graduates from triage.
- [x] Task: Conductor - Automated Review and Checkpoint 'Adjacent Frontier Extensions' (Protocol in workflow.md)
