...
- [x] **G7:** Record rights, privacy, scientific, practitioner and external
  evidence gates that apply to this workstream. (AC-05, AC-06) — `2923154`
...
- [x] Preserve expired H8 governance observations as immutable historical
  ...
  live CLI expiry rejection, refresh branch-specific documentation and
  reproduction pins, and make the local tox docs environment use its declared
  extractor dependency. (2026-08-14; hosted CI remediation for AC-03 and AC-07)
