...
class FluentDecisionAnalysis(DecisionAnalysis):
    ...
    def __init__(
        ...
        self._last_evpi_result: float | None = None
        self._last_evppi_result: float | None = None
        self._last_evsi_result: float | None = None

    def with_parameters(
        self, parameter_samples: np.ndarray | ParameterSet | dict[str, np.ndarray]
    ...
    def get_evpi_result(self) -> float | None:
        """
    ...
    def get_evppi_result(self) -> float | None:
        """
    ...
    def get_results(self) -> dict[str, float | None]:
        ...
        """
        return {"evpi": self._last_evpi_result, "evppi": self._last_evppi_result}
...
def create_analysis(
    ...
    **kwargs: object,
    ...
    return FluentDecisionAnalysis(
        nb_array=nb_array, parameter_samples=parameter_samples, **kwargs
    )
