...
OUTCOME_CONDITIONAL_SAMPLE_INFORMATION_INPUT_SCHEMA_V1: Final[dict[str, object]] = {
    ...
    "properties": {
        ...
        "reference_action": {
            "type": "string",
            "minLength": 1,
            "description": "Declared action that must attain the exact baseline extremum; tie_tolerance never makes a non-extremal reference admissible.",
        },
        ...
        "tie_tolerance": {
            "type": "number",
            "minimum": 0,
            "description": "Absolute value-unit tolerance for complete tie-set and presentation diagnostics only; not reference-action admissibility.",
        },
        "probability_tolerance": {
            "type": "number",
            "exclusiveMinimum": 0,
    ...
    "properties": {
        ...
        "assurance": {
            ...
            "properties": {
                ...
                "prior_probability_residual": _NUMBER,
                "maximum_likelihood_row_residual": _NUMBER,
                "probability_normalization_applied": {"type": "boolean"},
