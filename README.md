...
- [ ] **3. Core VOI Methods**
    ...
    - [x] Implement `evpi()` in `pyvoi/methods/basic.py`.
    - [x] Implement `evppi()` in `pyvoi/methods/basic.py`.
    - [x] Implement `evsi()` in `pyvoi/methods/sample_information.py`.
    - [x] Implement `enbs()` in `pyvoi/methods/sample_information.py`.
- [ ] **4. Unit Tests**
    - [ ] Write unit tests for all core data structures.
