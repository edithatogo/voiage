---
title: OpenSSF Best Practices Badge Readiness
description: The repository evidence boundary for a potential OpenSSF Best Practices badge application.
---
...
| Supply chain | pinned Actions, Renovate policy, dependency review, SBOM and provenance workflows | Confirm any criterion that requires a maintainer assertion |
...
6. Add a badge to public documentation only after the external service reports it.
