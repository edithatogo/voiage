...
These functions construct SDK-free voiage interchange profiles. They have not
been round-trip tested against pinned producer versions and do not claim
product compatibility with MLflow, OpenLineage, dbt, Statsig, GrowthBook,
EconML, or CausalML. Promotion requires a rights-cleared export and an executed
