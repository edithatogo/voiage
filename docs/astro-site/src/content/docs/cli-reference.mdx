...
`calculate-perspective` is an experimental, fixture-backed Python surface for
...
[perspective contract](https://github.com/edithatogo/voiage/blob/main/specs/frontier/perspective/v1/README.md) and
[capability dispositions](https://github.com/edithatogo/voiage/blob/main/specs/frontier/perspective/v1/capabilities.json)
...
`calculate-information-source-portfolio` consumes a finite joint-world law,
...
The result reports every evaluated design, complete action and sequence ties,
gross and signed net value, willingness to pay, prefix-conditional marginal
values and exact decision-value Shapley attribution. Dependence is evaluated
from the declared joint-world law; source values are not added independently.
The method remains experimental pending scientific review, stable promotion
and Rust/R/Julia parity.
