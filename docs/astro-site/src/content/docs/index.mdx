...
hero:
  ...
  actions:
    - text: Get Started
      link: /voiage/getting-started
      variant: primary
    - text: Introduction
      link: /voiage/introduction
    - text: GitHub
...
voiage is a comprehensive, cross-domain **Value of Information (VOI) analysis** library built with a Rust execution core and Python/Mojo surfaces, with thin R and Julia bindings.
...
- **Rust-first by design** — Python/Mojo reference surfaces with thin R and Julia bindings over the Rust core
...
- [Getting Started Guide](/voiage/getting-started)
- [API Reference](/voiage/api-reference)
- [Contributing Guide](/voiage/contributing)
