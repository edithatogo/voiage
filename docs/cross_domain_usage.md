...
The [business_strategy_example.py](../examples/business_strategy_example.py) demonstrates how to use voiage for evaluating market entry decisions:
...
The [environmental_policy_example.py](../examples/environmental_policy_example.py) demonstrates how to use voiage for evaluating pollution control measures:
