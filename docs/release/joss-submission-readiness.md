...
| JOSS manuscript structure | All contracted sections are substantive and ordered; the release-bound source has 1,583 body words, inside the repository's 1,568–1,632 target and JOSS's 750–1,750 range | Local contract ready; release-bound hosted confirmation pending |
...
| Reproducible JOSS PDF | Open Journals run `30166336066` and its six-page visual review establish the round-nine baseline. The retained decision-maker wording changes the source hash and therefore requires one fresh hosted build, artifact digest, Textstat report, and page-by-page inspection before tagging | Pending release-bound evidence |
