...
| Reproducible JOSS PDF | Official Open Journals workflow run 30162649796 passed for the previous source revision, and all six pages passed visual review. The criteria-reconciled source requires a fresh hosted build, visual inspection, and review-only Textstat report | Pending current-source evidence |
