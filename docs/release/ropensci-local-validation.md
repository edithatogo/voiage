...
The rOpenSci `pkgcheck` run passed on 2026-07-27 in that isolated library. It
is evidence for local package quality only. A self-contained FFI distribution,
maintainer commitment, scope decision, inquiry, review, and acceptance remain
separate gates.
